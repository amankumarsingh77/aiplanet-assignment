...
const OpenAIConversationalAgentNode = memo(({ data }) => {
    ...
    const handleMaxTokenLimitChange = (e) => {
        setMaxTokenLimit(parseInt(e.target.value, 10));
    };
    ...
    const handleOpenaiApiBaseChange = (e) => {
        setOpenaiApiBase(e.target.value);
    };
    ...
    return (
        <div className="bg-white shadow-md rounded-lg p-6 w-96">
            ...
            <div className="mb-4">
                <label htmlFor="maxTokenLimit" className="block text-gray-700 font-bold mb-2">
                    Max Token Limit
                </label>
                <input
                    id="maxTokenLimit"
                    type="number"
                    value={maxTokenLimit}
                    onChange={handleMaxTokenLimitChange}
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
            </div>

            <div className="mb-4">
                <label htmlFor="modelName" className="block text-gray-700 font-bold mb-2">
                    Model Name
                </label>
                <select
                    id="modelName"
                ...
                >
                    {models.map((model, key) =>
                        <option key={key} value="">{model}</option>
                    )}
                </select>
            </div>
            ...
            <div className="mb-4">
                <label htmlFor="openaiApiBase" className="block text-gray-700 font-bold mb-2">
                    OpenAI API Base
                </label>
                <input
                    id="openaiApiBase"
                    ...
                    value={openaiApiBase}
                    onChange={handleOpenaiApiBaseChange}
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
            </div>

            <div className="mb-4">
                <label htmlFor="openaiApiKey" className="block text-gray-700 font-bold mb-2">
                    OpenAI API Key
...
export default OpenAIConversationalAgentNode;